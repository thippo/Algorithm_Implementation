...
class Genetic_Algorithm():
    ...
    def __init__(self,population_size=50,interval=(-10,10,6),fitness_function='pass',crossover_probability=0.8,mutation_probability=0.1):
    ...
    def run(self,reproduce_generation=50):
        pass
